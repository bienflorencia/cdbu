...
links = [{icon_pack = "ai", icon="open-access", name="Datos", url = "https://doi.org/10.5281/zenodo.3954406"}]
...
<th align="right">Número de Registros</th>
...
Los datos serán actualizada con nuevos registros periódicamente, chequeá el repositorio de Zenodo para obtener la última versión.  
...
----
<iframe src='/img/PlantasMap.html' height='700' width="100%"> 
</iframe>
