...
Find the publication here: [**Biodiversidata: An Open-Access BiodiversityDatabase for Uruguay**](https://doi.org/10.3897/BDJ.7.e36226)  

Check out the [Vertebrates Database](https://biodiversidata.org/en/project/tetrapods/) in the Resources Section and download the complete database or the species checklists for each group.  
